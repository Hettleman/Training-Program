...
var APP_com_domain_app_week1topic1practice1 = (function () {
  ...
  class App extends Lightning$1.Component {
    constructor() {
       ...
       */
      this.Background = this.getByRef('Background');
      this.Logo = this.Background.getByRef('Logo');
      this.Text = this.Background.getByRef('Text');
      this.Mystery = this.Background.getByRef('Mystery');
    }
    static _template() {
      return {
        w: 1920,
